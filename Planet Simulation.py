...
PERU = (200, 139, 58)
GRULLO = (164, 155, 114)
POWDER_BLUE = (187, 225, 228)
ROYAL_BLUE = (62, 102, 249)
...
def main():
		...
		earth = Planet(-1 * Planet.AU, 0, 2, BLUE, 5.9742 * 10**24)
		...
		jupiter = Planet(5.203 * Planet.AU, 0, 9, PERU, 1.898 * 10**27)
		jupiter.y_vel = -13.1 * 1000

		saturn = Planet(-9.539 * Planet.AU, 0, 8, GRULLO, 5.683 * 10**26)
		saturn.y_vel = 9.700 * 1000

		uranus = Planet(-19.18 * Planet.AU, 0, 5,POWDER_BLUE, 8.681 * 10**25)
		uranus.y_vel = 6.8 * 1000

		neptune = Planet(30.06 * Planet.AU, 0, 4, ROYAL_BLUE, 1.024 * 10**26)
